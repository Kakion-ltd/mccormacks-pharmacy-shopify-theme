...
ck("base.css has the homepage chip-row modifier", mod is not None)
if mod:
...
ck("homepage row carries the modifier", 'class="chip-row-compact"' in theme("sections", "category-pills.liquid"))
