...
// The fixture catalogue, shared with serve_preview.py (cart and product JSON) and
// provision.mjs (seeding the dev store), so all three cannot disagree about a price.
